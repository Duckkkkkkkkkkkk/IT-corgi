...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseList.add(new Course(2, "python", "Профессия Python\nразработчик", "1 сентября", "junior", "#9FA52D", "9-месячная программа обучения, во время которой ученик на практике научится понимать фундаментальные алгоритмы и использовать их для написания сайтов, приложений, нейросетей и Telegram-бота.", 3, "4225"));
